...
- **Senior.** Three pillars — logs, metrics, traces. Sportz now has all three on the backend (Winston + New Relic APM); frontend RUM/traces are wired but need Vercel env vars to activate. ([Observability](/operations/observability).)
