...
<Card title="Try the live demo" icon="rocket" href="https://sportz-ui.vercel.app" horizontal>
...
| Live score updates (broadcast to all) | ✅ Built | [ADR-010](/decisions), [API Reference](/reference/api) |
| Demo mode (in-process multi-sport simulator) | ✅ Built | [ADR-011](/decisions) |
...
| Frontend observability (New Relic, PostHog) | ✅ Built | [Observability](/operations/observability) |
| Backend observability (New Relic APM, PostHog) | ✅ Built | [Observability](/operations/observability) |
