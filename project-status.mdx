...
- **Frontend observability** — New Relic Browser and PostHog are integrated in code, but inert until their keys are set on Vercel and the app is redeployed. Sentry was removed entirely ([ADR-013](/decisions)). See [Observability](/operations/observability).
